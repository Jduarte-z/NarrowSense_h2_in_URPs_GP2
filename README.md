...
2. **Methods that exploit linkage disequilibrium among genetic variants (LD scores)** — require the presence of an LD reference panel appropriate to the population in question, tend to give more conservative (lower) heritability estimates. Classically exemplified in the Linkage Disequilibrium Score Regression method (LDSC).
